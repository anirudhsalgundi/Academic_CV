...
% \begin{enumerate}
% \item \me., et al. (\textit{in prep}) (2024), {``Bursts, Beats, and Beyond: Uncovering landscape from accretion to ignition of 4U 1728-34 using \textit{AstroSat}"} \textit{(submitted to JAA)}
...
\begin{enumerate}[itemsep=-0.5em, leftmargin=0.5em] % Set itemsep for this enumerate
    ...
    \item Srinivasaragavan, G., ..... ., \me., et al. (2025), {\href{https://arxiv.org/abs/2501.03337}{``Multi-Wavelength Analysis of AT 2023sva: a Luminous Orphan Afterglow With Evidence for a Structured Jet"}}. \textit{(submitted to MNRAS, under review)}
