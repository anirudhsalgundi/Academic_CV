...
\begin{enumerate}[itemsep=-0.5em, leftmargin=0.5em] % Set itemsep for this enumerate
    ...
    \item Srinivasaragavan, G., ..... ., \me., et al. (2024), {``AT 2023sva: Multi-wavelength Analysis of an Optically-Discovered Afterglow Without a Detected Gamma-ray Counterpart"}. \textit{(submitted to PASP)}
